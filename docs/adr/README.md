...
- [ADR-001: Modular monolith before microservices](001-modular-monolith.md)
- [ADR-002: HttpOnly cookie sessions](002-cookie-sessions.md)
- [ADR-003: Organization scope and PostgreSQL RLS](003-tenant-isolation.md)
- [ADR-004: Transactional outbox](004-transactional-outbox.md)
- [ADR-005: OCR produces drafts only](005-ocr-drafts.md)
